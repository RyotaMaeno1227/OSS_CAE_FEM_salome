...
static void push_constraint_case(SolveResult *res,
    ...
    ConstraintStats stats = compute_stats(c);
    const char *label = name_override ? name_override : c->name;
    add_case(res, label, time, &stats);
}
...
SolveResult run_coupled_constraint(void) {
    ...
    Constraint2D distance = {.name = "optic_alignment_trim",
                             ...
                             .anchor_a = {0.0, 0.0},
                             .anchor_b = {0.1, -0.05}};
    push_constraint_case(&res, &distance, 0.0, NULL);
    ...
    Constraint2D revolute = {.name = "tele_yaw_control",
                             ...
                             .anchor_a = {0.0, 0.0},
                             .anchor_b = {0.0, 0.0}};
    push_constraint_case(&res, &revolute, 1.0, NULL);
    ...
    push_constraint_case(&res, &planar, 2.0, NULL);
    ...
    push_constraint_case(&res, &prismatic, 3.0, NULL);
    ...
    Constraint2D gear = {.name = "counterbalance_beam",
                         ...
                         .anchor_a = {0.0, 0.0},
                         .anchor_b = {0.0, 0.0}};
    push_constraint_case(&res, &gear, 4.0, NULL);
    ...
    push_constraint_case(&res, &contact_slip, 6.0, NULL);
...
SolveResult run_contact_regression(void) {
    ...
    push_constraint_case(&res, &contact_slip, 0.0, contact_slip.name);
