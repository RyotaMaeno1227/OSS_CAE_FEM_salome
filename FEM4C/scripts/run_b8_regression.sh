...
run_make_target() {
  env -u MAKEFLAGS -u MFLAGS -u B8_TEST_TMP_COPY_DIR "$b8_make_cmd" -C FEM4C "$@"
}

run_make_target mbd_b8_syntax
run_make_target mbd_b8_guard_output_test
run_make_target mbd_ci_contract
run_make_target mbd_ci_contract_test
...
echo "PASS: b8 regression (contract + self-tests + guard-contract; run_b14_regression=$b8_run_b14_regression b14_target=$b8_b14_target)"
