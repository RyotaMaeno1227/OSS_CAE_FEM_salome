...
!  problem and modeling specification
   ...
   integer,parameter        :: nstr  =5      ! Number of Strain Component

   integer,parameter        :: mtype =4      ! Material type
   integer,parameter        :: nstrss=5      ! Number of Stress Component
...
contains
  ...
  &      =reshape( (/ 1,1, 1,2, 2,1, 2,2 /),(/ndim,nint/) )
