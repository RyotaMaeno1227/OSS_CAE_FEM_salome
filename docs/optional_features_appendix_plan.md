...
| `docs/wiki_coupled_endurance_article.md:42`-`docs/wiki_coupled_endurance_article.md:116` | 社内 Wiki 投稿テンプレ／スクリーンショット管理 | 通知／レポート運用 | Appendix B（同上） | 本編ではフロー概要のみを保持、テンプレ全文とチェックリストを Appendix へ。 |
