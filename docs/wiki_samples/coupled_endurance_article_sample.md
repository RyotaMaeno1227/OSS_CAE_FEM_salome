...
- [チートシート（Markdown）](../coupled_constraint_presets_cheatsheet.md) ※ Markdown が正。PDF が必要な場合は Appendix A.3.2 で各自変換。
...
|-------------|--------|--------------|----------|----------------|------|
| 2025-10-20 | Kobayashi | Tanaka | summary・スクリーンショット更新、Contact+Coupled 判定ログを Appendix B.6 へ反映 | ✅ `.md` のみ参照 | Slack `#chrono-docs` 通知済み |
